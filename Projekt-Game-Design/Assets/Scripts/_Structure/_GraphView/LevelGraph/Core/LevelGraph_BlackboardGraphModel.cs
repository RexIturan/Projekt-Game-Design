...
namespace Editor.GraphEditors.StateMachineWrapper.Editor {
	public class LevelGraph_BlackboardGraphModel : BlackboardGraphModel {
		internal static readonly string[] Sections = { "Blackboard List1" };

		/// <inheritdoc />        
		public LevelGraph_BlackboardGraphModel(IGraphAssetModel graphAssetModel)
