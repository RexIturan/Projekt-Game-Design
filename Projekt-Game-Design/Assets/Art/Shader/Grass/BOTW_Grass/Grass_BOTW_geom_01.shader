Shader "Unlit/Grass_geom"{
    ...
    Properties {
        ...
        _BladeBendCurve("Blade Bend Curve", Range(1, 4)) = 2
        
        _BendDelta("Bend Variation", Range(0, 1)) = 0.2
        
        _TessellationGrassDistance("Tesselation Grass Distance", Range(0.01, 2)) = 0.1
        ...
        _WindFrequency("Wind Pulse Frequency", Range(0, 1)) = 0.1
    }
