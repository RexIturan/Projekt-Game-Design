...
#pragma warning disable CS0414
        [HideInInspector][SerializeField] private bool m_FallbackOnIMGUIKeyboardEvents = false;
#pragma warning restore CS0414
	    
///// Custom Code Begin
	    [SerializeField] private bool m_deselectIfNoTarget = false;
///// Custom Code End 
        ...
        private void ProcessPointerClick(PointerEvent pointerEvent, int button, bool pressed)
        {
            if (pressed)
            {
                ...
                SendPositionBasedEvent(pointerEvent.position, pointerEvent.deltaPosition, pointerEvent.pointerId, pointerEvent.targetDisplay,
                    ...
                    }, pointerEvent, deselectIfNoTarget: m_deselectIfNoTarget);
            }
            else
            {
